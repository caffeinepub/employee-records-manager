...
export function InternetIdentityProvider({
  ...
  // Store authClient in a ref so that setting it never triggers a re-render
  // or causes the init effect to run again.
  ...
  // Initialize the auth client exactly once on mount.
  useEffect(() => {
    let cancelled = false;
    void (async () => {
      try {
